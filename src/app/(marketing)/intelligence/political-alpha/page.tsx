              ...
              <tbody className="divide-y divide-border-slate/30">
                {recentTrades.map((trade: any, i: number) => (
                  <tr key={i} className="hover:bg-background-elevated/20 transition-colors group">
                    ...
                    <td className="px-8 py-5 font-mono text-text-secondary">{trade.amount}</td>
                    <td className="px-8 py-5 text-right">
                      <button className="text-[10px] font-bold uppercase tracking-widest text-text-tertiary group-hover:text-accent flex items-center justify-end gap-2 ml-auto">
