...
const logoMap: Record<string, { domain: string; color?: string }> = {
  ...
  "Sky News Business": { domain: "news.sky.com", color: "#CC0000" },
  "Sky News": { domain: "news.sky.com", color: "#CC0000" },
  "Sky": { domain: "news.sky.com", color: "#CC0000" },
  "WSJ Markets": { domain: "wsj.com", color: "#000000" },
  "WSJ": { domain: "wsj.com", color: "#000000" },
  "MarketWatch": { domain: "marketwatch.com", color: "#3B2E2A" },
  "Yahoo Finance": { domain: "finance.yahoo.com", color: "#720099" },
