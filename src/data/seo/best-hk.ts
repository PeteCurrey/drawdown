...
export const BEST_OF_PAGES_HK: BestOfPage[] = [
  {
    ...
    bestOverall: { name: 'IG Hong Kong', reason: 'Unmatched global access and SFC regulatory security.', link: 'https://ig.com/hk' },
    comparisonTable: [
  ...
  ...['trading-platform-hong-kong', 'cfd-broker-hong-kong', 'broker-for-beginners-hong-kong', 'crypto-trading-hong-kong', 'trading-course-hong-kong', 'trading-app-hong-kong', 'prop-firm-hong-kong'].map(slug => ({
    ...
    bestOverall: { name: 'Interactive Brokers', reason: 'Professional execution and the lowest margin rates available in HK.', link: 'https://interactivebrokers.com.hk' },
    comparisonTable: [],
    sections: [],
