  ...
  return (
    <div className="pt-28 pb-24 bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-[11px] font-sans font-bold text-mkt-i4 uppercase tracking-widest block mb-5">
            // OUR MANIFESTO
          </span>
          <h1 className="text-4xl md:text-6xl font-sans font-extrabold tracking-tight text-mkt-ink leading-tight mb-10">
            Trading is hard.<br />
            Guru culture<br />
            is <span className="text-mkt-grn">toxic.</span>
          </h1>

          <div className="space-y-6 text-base text-mkt-i3 leading-relaxed font-sans max-w-2xl">
            <p>
            ...
            <blockquote className="border-l-2 border-mkt-bd pl-6 py-3 bg-[#F7F7F7] rounded-r-[12px] italic text-mkt-i2">
        ...
        {/* Pillars */}
        <div className="mb-24 pt-12 border-t border-mkt-bd">
          <span className="text-[11px] font-sans font-bold text-mkt-i4 uppercase tracking-widest block mb-10">
            // OUR FOUR PILLARS
          </span>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {pillars.map((pillar, i) => (
              <motion.div
                ...
                className="relative border border-mkt-bd rounded-[14px] p-6 overflow-hidden group cursor-default transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(0,0,0,0.07)]"
              ...
              >
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-sans font-extrabold tracking-tight text-mkt-ink mb-3">
                    {pillar.title}
                  </h3>
                  <p className="text-xs text-mkt-i3 leading-relaxed font-sans">{pillar.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        {/* Founder Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24 pt-12 border-t border-mkt-bd">
          <motion.div
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-sans font-extrabold tracking-tight text-mkt-ink mb-8 leading-snug">
              The Man Behind the Data.
            </h2>
            <div className="space-y-5 text-sm text-mkt-i3 leading-relaxed font-sans">
              <p>
              ...
              <p className="font-semibold text-mkt-i2">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] border border-mkt-bd rounded-[14px] overflow-hidden relative group">
              <div
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="bg-[#F7F7F7] border border-mkt-bd rounded-[14px] p-12 md:p-16 text-center relative overflow-hidden"
        >
          <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            ...
            <p className="text-[10px] font-sans font-bold text-mkt-i4 uppercase tracking-widest">
              // Pete Currey, Founder
            </p>
            <Link
              href="/signup"
