// ── scripts/stripe-migration-dry-run.mjs ──
...
async function runDryRun() {
  ...
  if (!stripeSecretKey || stripeSecretKey.includes("placeholder")) {
    ...
    try {
      ...
      console.warn("⚠️ Stripe API error or invalid key. Generating mock simulation data for admin review...");
      // Mock data simulation (12 subscribers on old Edge plan)
      affectedSubscribers = 12;
      currentMRR = 12 * 149;
      projectedMRR = 12 * 99;
  ...
  const report = {
    ...
    legacyPriceId: legacyEdgePriceId,
    newEdgePriceId,
    affectedSubscribers,
    currentMRR,
    projectedMRR,
