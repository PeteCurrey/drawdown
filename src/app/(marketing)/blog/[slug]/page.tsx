      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="space-y-8 mb-16">
            ...
            <h1 className="text-4xl md:text-7xl font-sans font-bold uppercase leading-[1.1] text-text-primary tracking-tight">
              {post.title}
            </h1>
            
            <div className="flex flex-wrap items-center gap-8 text-[10px] font-mono uppercase tracking-widest text-text-tertiary border-y border-border-slate/50 py-6">
          ...
          {/* Table of Contents */}
          {showTOC && (
            <div className="mb-16 p-8 bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5">
          ...
          <article 
            className="prose prose-invert prose-drawdown max-w-none prose-headings:font-sans prose-headings:uppercase prose-headings:text-text-primary prose-h2:text-3xl prose-h2:mt-16 prose-h2:mb-8 prose-h2:pt-16 prose-h2:border-t prose-h2:border-border-slate/50/30 prose-h3:text-xl prose-h3:mt-10 prose-p:text-text-secondary prose-p:leading-relaxed prose-p:text-lg prose-p:mb-8 prose-strong:text-text-primary prose-strong:font-bold prose-blockquote:border-l-4 prose-blockquote:border-border-slate/50 prose-blockquote:bg-background-elevated/40/30 prose-blockquote:p-8 prose-blockquote:italic prose-blockquote:text-text-primary prose-ul:list-disc prose-ul:pl-6 prose-ul:mb-10 prose-li:text-text-secondary prose-li:mb-4 prose-a:text-accent prose-a:underline hover:prose-a:text-accent-hover"
          >
            <MDXRemote source={post.content} />
          </article>

          {/* Author Bio */}
          <div className="mt-24 p-10 bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5 relative overflow-hidden">
             ...
             <div className="flex flex-col md:flex-row items-center md:items-start gap-8 relative z-10">
                <div className="w-24 h-24 bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5 flex items-center justify-center shrink-0">
                  <span className="text-3xl font-sans font-black text-profit">PC</span>
                </div>
                <div className="space-y-4 text-center md:text-left">
                   <div>
                      <h5 className="text-xl font-sans font-bold uppercase text-text-primary">Pete Currey</h5>
          ...
          {relatedPosts.length > 0 && (
            <div className="mt-32 space-y-12">
               <h4 className="text-[10px] font-mono uppercase tracking-widest text-text-tertiary border-b border-border-slate/50 pb-4">// Related Insights</h4>
          ...
          {/* Final CTA */}
          <div className="mt-32 p-12 bg-background-elevated/40 border border-border-slate/50 relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-1 h-full bg-accent" />
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="space-y-4">
                <h4 className="text-3xl font-sans font-bold uppercase text-text-primary leading-none">Stop Gambling. <br /> Start Trading.</h4>
