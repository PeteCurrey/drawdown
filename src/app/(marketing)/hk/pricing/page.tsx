...
const tiers = [
  {
    name: "Foundation",
    id: "foundation",
    description: "For Hong Kong beginners building their knowledge base.",
    ...
    features: [
      ...
      { name: "SFC Broker Directory", included: true },
      { name: "Position Size Calculator (HKD)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "HSI & Asian Session Modules", included: true },
  ...
  },
  {
    name: "Floor",
    id: "floor",
    description: "Direct access and bespoke HK market analysis.",
...
export default function HongKongPricingPage() {
  ...
  const handleSubscribe = async (tierId: string) => {
    ...
    try {
      const plan = (HK_PRICING as any)[tierId];
      const stripePriceId = plan.stripePriceId;

      const response = await fetch("/api/stripe/checkout", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ priceId: stripePriceId, tier: tierId, region: 'HK' }),
      });
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-24 p-12 bg-[#F7F7F7] border border-mkt-bd max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center">
           ...
           <div className="space-y-4 text-center md:text-left">
              <h4 className="text-xl font-sans font-bold uppercase tracking-widest text-mkt-ink">SFC Compliance</h4>
