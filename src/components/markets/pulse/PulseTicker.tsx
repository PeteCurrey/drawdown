...
export function PulseTicker() {
  ...
  return (
    <div className="bg-background-elevated border-y border-border-slate w-full overflow-hidden h-12 flex items-center relative z-20">
      <div className="absolute left-0 top-0 bottom-0 bg-background-elevated px-4 flex items-center gap-2 z-30 border-r border-border-slate shadow-[10px_0_20px_rgba(0,0,0,0.5)]">
