                    ...
                    <div className="flex items-center gap-1.5 justify-center">
                      ...
                      {md.is_fallback && (
                        <div className="group relative flex items-center justify-center cursor-help">
                          ...
                          <div className="absolute bottom-full mb-2 hidden group-hover:block w-48 p-2 text-xs bg-white border border-[#DEDDD8] rounded shadow-lg text-[#1A1A1A] text-left z-50 whitespace-normal">
