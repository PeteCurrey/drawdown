...
export const metadata: Metadata = getMetadata({
  title: "Best of Trading Hong Kong — Expert Rankings & Reviews",
  description: "The definitive rankings of the best forex brokers and trading tools for Hong Kong traders. Tailored for SFC compliance.",
  path: "/hk/best",
});

export default function HKBestIndex() {
  return (
    <RegionalProvider region="hk">
      <div className="pt-32 pb-24 bg-background-primary min-h-screen">
        <TrackPageView path="/hk/best" />
        <div className="container mx-auto px-6">
          <header className="mb-16 max-w-4xl">
            ...
            <p className="text-xl text-text-secondary leading-relaxed max-w-2xl">
              We rank the best trading gateways and software for the Hong Kong market. Our rankings focus on SFC regulatory security and professional performance.
            </p>
          </header>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {BEST_OF_PAGES_HK.map((page) => (
              <Link 
                key={page.slug}
                href={`/hk/best/${page.slug}`}
