      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-4xl mt-12 space-y-16">
          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-12">
            <section className="p-8 bg-white border border-warning/20 space-y-6">
               <h2 className="text-xl font-sans font-bold uppercase m-0 text-warning">Mandatory CFTC Disclosure</h2>
               <p className="text-[10px] font-mono uppercase leading-relaxed text-mkt-i2 m-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-12">
             <div className="p-8 border border-mkt-bd flex gap-6 items-start">
                <Shield className="w-8 h-8 text-accent shrink-0" />
                <div>
                   <h3 className="font-sans font-bold uppercase mb-2">SEC/FINRA</h3>
                   <p className="text-xs text-mkt-i4 leading-relaxed">We adhere to US securities laws regarding the dissemination of educational materials on equities and options.</p>
                </div>
             </div>
             <div className="p-8 border border-mkt-bd flex gap-6 items-start">
                ...
                <div>
                   ...
                   <p className="text-xs text-mkt-i4 leading-relaxed">Our forex and futures content is strictly educational and compliant with NFA member guidelines.</p>
                </div>
             </div>
          </div>
        </div>
