    ...
    <div className="pt-28 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-invert prose-drawdown max-w-none space-y-12 text-text-secondary leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">2. How We Use Your Data</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">3. Data Security & Storage</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">4. Cookies & Tracking</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">5. Your Rights</h2>
            <p>
          ...
          <section className="p-8 bg-background-elevated/40 border border-border-slate/50">
            <h3 className="text-sm font-sans font-bold uppercase mb-2 text-text-primary">Contact Us regarding privacy</h3>
            <p className="text-xs">
