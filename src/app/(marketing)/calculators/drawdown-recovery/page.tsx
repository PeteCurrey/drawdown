      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-5 p-8 border border-mkt-bd bg-white space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-[10px] font-mono uppercase tracking-widest">
                <span className="text-mkt-i4">Account Drawdown Level</span>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between gap-6">
            <div className="p-8 border border-mkt-bd bg-[#F7F7F7]/30 hover:border-accent transition-colors flex flex-col justify-between">
              <span className="text-[9px] font-mono text-mkt-i4 uppercase tracking-widest">Required Growth</span>
              <div className="mt-8">
                <p className="text-4xl font-sans font-black text-accent">{recoveryPercent.toFixed(1)}% Gain</p>
                <p className="text-[9px] font-mono text-mkt-i4 mt-2 uppercase tracking-widest">REQUIRED GAIN TO RETURN TO BREAKEVEN</p>
              </div>
            </div>
            ...
            <div className="p-6 border border-accent/20 bg-accent/5 flex items-start gap-4">
              ...
              <div>
                <h4 className="text-xs font-bold uppercase tracking-tight text-mkt-ink">Asymmetry Warning</h4>
        ...
        <div className="mb-20 space-y-6">
          <h3 className="text-xs font-mono font-black uppercase tracking-widest text-mkt-ink">// THE ASYMMETRY OF LOSS</h3>
          <div className="grid grid-cols-3 md:grid-cols-9 gap-4 text-center">
            {recoveryPairs.map((pair) => (
              <div key={pair.loss} className="p-4 border border-mkt-bd flex flex-col justify-between bg-[#F7F7F7]/20">
        ...
        <article className="prose prose-slate max-w-none text-mkt-i2 leading-relaxed mb-20 space-y-8 border-t border-mkt-bd/30 pt-16">
          <h2 className="text-3xl font-sans font-black uppercase text-mkt-ink">The Mathematics of Capital Drawdown Recovery</h2>
          <p>
          ...
          <h3 className="text-xl font-bold uppercase text-mkt-ink">The Recovery Formula</h3>
          <p>
          ...
          <h3 className="text-xl font-bold uppercase text-mkt-ink">Why Protecting Capital is Key</h3>
          <p>
