    ...
    <div className="space-y-6">
      ...
      <div className="mt-12 p-6 bg-background-elevated/30 border border-border-slate/50 flex gap-4 items-start">
        ...
        <p className="text-[10px] text-text-tertiary leading-relaxed font-mono uppercase">
          Signals are generated by the Drawdown Intelligence Engine using institutional-grade data. Past performance is not indicative of future results. Confirm all signals with technical confluence before execution.
        </p>
      </div>
    </div>
  );
