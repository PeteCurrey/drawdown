      ...
      <div className="max-w-7xl mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="aspect-video bg-white border border-mkt-bd relative flex flex-col items-center justify-center p-8 text-center group overflow-hidden">
              <div className="absolute inset-0 bg-accent/5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
              <Video className="w-12 h-12 text-mkt-i4 mb-6 opacity-50" />
              <h2 className="text-2xl font-sans font-bold uppercase mb-4 text-mkt-ink">Stream Offline</h2>
              <p className="text-xs font-mono text-mkt-i2">
                The next live session begins at 08:00 AM GMT (London Open).
              </p>
              
              <div className="absolute top-6 left-6 flex items-center gap-2 px-3 py-1.5 bg-[#F7F7F7] border border-mkt-bd rounded-full">
                <div className="w-2 h-2 rounded-full bg-text-tertiary" />
                <span className="text-[9px] font-mono uppercase tracking-widest text-mkt-i2">Offline</span>
              </div>
            </div>

            <div className="bg-white border border-mkt-bd p-8">
              <h3 className="text-lg font-sans font-bold uppercase mb-6 flex items-center gap-2 text-mkt-ink">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className={cn(
                    ...
                    item.active ? "bg-accent/5 border-mkt-bd/20" : "bg-[#F7F7F7] border-mkt-bd"
                  )}>
                    <div className="flex flex-col gap-1">
                      <span className="text-[10px] font-mono text-mkt-i4 uppercase tracking-widest">{item.time}</span>
                      <span className={cn(
                        "text-sm font-bold uppercase",
                        item.active ? "text-accent" : "text-mkt-ink"
                      )}>{item.title}</span>
                    </div>
          ...
          {/* Chat / Sidebar Area */}
          <div className="bg-white border border-mkt-bd flex flex-col h-[600px] lg:h-auto">
            <div className="p-6 border-b border-mkt-bd flex items-center justify-between">
               <h3 className="text-lg font-sans font-bold uppercase flex items-center gap-2 text-mkt-ink">
                 <Users className="w-5 h-5 text-accent" /> Live Chat
               </h3>
               <span className="text-[9px] font-mono uppercase tracking-widest text-mkt-i4 flex items-center gap-1">
            ...
            <div className="flex-grow p-6 flex flex-col items-center justify-center text-center px-8 relative overflow-hidden">
               ...
               <div className="relative z-20 space-y-4">
                  <Lock className="w-8 h-8 text-mkt-i4 mx-auto mb-4" />
                  <p className="text-sm font-bold uppercase">Offline Chat Disabled</p>
                  <p className="text-[10px] font-mono text-mkt-i2 leading-relaxed">
                     The chat room automatically opens 15 minutes before scheduled live sessions.
                  </p>
               </div>
            </div>
            
            <div className="p-4 border-t border-mkt-bd bg-[#F7F7F7]">
               <input 
                 disabled
                 type="text" 
                 placeholder="Chat is currently disabled..." 
                 className="w-full bg-white border border-mkt-bd px-4 py-3 text-sm focus:outline-none opacity-50 cursor-not-allowed"
               />
            </div>
          </div>
        </div>
