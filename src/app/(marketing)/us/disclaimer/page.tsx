      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mt-12 space-y-16">
          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-12">
            <section className="p-8 bg-background-surface border border-warning/20 space-y-6">
               <h2 className="text-xl font-display font-bold uppercase m-0 text-warning">Mandatory CFTC Disclosure</h2>
            ...
            <section className="space-y-6">
               <h2 className="text-2xl font-display font-bold uppercase tracking-tight">No Income Claims</h2>
            ...
            <section className="space-y-6">
               <h2 className="text-2xl font-display font-bold uppercase tracking-tight">Not a Registered Advisor</h2>
               <p className="text-lg text-text-secondary leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-12">
             <div className="p-8 border border-border-slate flex gap-6 items-start">
                <Shield className="w-8 h-8 text-accent shrink-0" />
                <div>
                   <h3 className="font-display font-bold uppercase mb-2">SEC/FINRA</h3>
             ...
             <div className="p-8 border border-border-slate flex gap-6 items-start">
                ...
                <div>
                   <h3 className="font-display font-bold uppercase mb-2">CFTC/NFA</h3>
