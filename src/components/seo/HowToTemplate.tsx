            ...
            <div className="prose prose-invert prose-slate max-w-none">
              ...
              <div className="space-y-16">
                {page.steps.map((step, i) => (
                  <div key={i} className="relative pl-12 border-l border-border-slate pb-12 last:pb-0">
                    ...
                    <h2 className="text-2xl font-display font-bold uppercase tracking-tight mb-6 m-0">{step.title}</h2>
