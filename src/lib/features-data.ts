...
export const FEATURES_DATA: Record<string, FeatureDetail> = {
  ...
  "ai-market-scanner": {
    ...
    icon: Scan,
    image: "https://images.unsplash.com/photo-1642790103517-1a52f81862ae?q=80&w=1200",
    tier: "Edge+",
  ...
  "strategy-backtester": {
    ...
    icon: History,
    image: "https://images.unsplash.com/photo-1644088379091-d574269d422f?q=80&w=1200",
    tier: "Edge+",
