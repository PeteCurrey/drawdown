          ...
          <div className="space-y-8">
            {AU_BROKERS.map((broker, index) => (
              <div key={broker.slug} className="bg-white border border-mkt-bd hover:border-mkt-bds/30 transition-all p-8 md:p-12 relative overflow-hidden group">
                 {/* Ranking Number */}
                 <div className="absolute -top-4 -left-4 text-9xl font-sans font-black text-white/5 select-none italic group-hover:text-mkt-grn transition-colors">
                    0{index + 1}
                 </div>
                 ...
                 <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <div className="lg:col-span-4 space-y-4">
                       <div className="flex items-center gap-3">
                          <h3 className="text-3xl md:text-4xl font-sans font-black uppercase text-mkt-ink">{broker.name}</h3>
                          {broker.badge && (
      ...
      <section className="py-24 bg-white border-y border-mkt-bd">
         <div className="max-w-7xl mx-auto px-6 text-center">
            <div className="max-w-2xl mx-auto space-y-8">
               ...
               <Link href="/au/courses" className="inline-flex items-center gap-4 bg-white text-[#08090D] px-10 py-5 font-sans font-black uppercase tracking-[0.2em] text-sm hover:translate-y-[-2px] transition-all">
