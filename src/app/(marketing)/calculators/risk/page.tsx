      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-5 p-8 border border-mkt-bd bg-white space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-mono uppercase tracking-widest text-mkt-i4">Stop Loss (Pips)</label>
              <input 
                type="number"
                value={stopLossPips}
          ...
          <div className="lg:col-span-7 flex flex-col justify-between gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
              <div className="p-8 border border-mkt-bd bg-[#F7F7F7]/30 flex flex-col justify-between hover:border-accent transition-colors">
                <span className="text-[9px] font-mono text-mkt-i4 uppercase tracking-widest">Cash Exposure</span>
                <div className="mt-8">
                  ...
                  <p className="text-[9px] font-mono text-mkt-i4 mt-2 uppercase tracking-widest">TOTAL VALUE EXPOSED</p>
                </div>
              </div>

              <div className="p-8 border border-mkt-bd bg-[#F7F7F7]/30 flex flex-col justify-between hover:border-accent transition-colors">
                <span className="text-[9px] font-mono text-mkt-i4 uppercase tracking-widest">Risk Percentage</span>
                <div className="mt-8">
                  <p className="text-3xl font-sans font-black text-accent">{riskPercent.toFixed(2)}%</p>
                  <p className="text-[9px] font-mono text-mkt-i4 mt-2 uppercase tracking-widest">OF TOTAL CAPITAL BALANCE</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 border border-accent/20 bg-accent/5 flex items-start gap-4">
              ...
              <div>
                <h4 className="text-xs font-bold uppercase tracking-tight text-mkt-ink">Survival Statistics</h4>
        ...
        <article className="prose prose-slate max-w-none text-mkt-i2 leading-relaxed mb-20 space-y-8 border-t border-mkt-bd/30 pt-16">
          <h2 className="text-3xl font-sans font-black uppercase text-mkt-ink">Understanding Risk Exposure in Live Markets</h2>
          <p>
          ...
          <h3 className="text-xl font-bold uppercase text-mkt-ink">How to Check Capital Risk</h3>
          <p>
          ...
          <h3 className="text-xl font-bold uppercase text-mkt-ink">Why a 1% Limit is Recommended</h3>
          <p>
