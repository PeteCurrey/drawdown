...
export const INSTRUMENTS: Instrument[] = [
  ...
  // CRYPTO (8)
  {
    ...
    bestBrokerId: 'etoro',
    relevantCoursePhase: 'Phase 6'
  },
  { slug: 'ethereum', name: 'Ethereum (ETH)', symbol: 'ETHUSD', type: 'crypto', description: 'The leading smart contract platform.', keyFacts: { hours: '24/7', spread: 'Variable', contractSize: '1 ETH', leverage: '1:2' }, fundamentalDrivers: ['Network Upgrades', 'Gas Fees', 'DeFi Volume'], tradingTips: ['Correlates with BTC.', 'Staking demand is key.'], relatedInstruments: ['bitcoin', 'solana', 'chainlink'], bestBrokerId: 'etoro', relevantCoursePhase: 'Phase 6' },
  { slug: 'solana', name: 'Solana (SOL)', symbol: 'SOLUSD', type: 'crypto', description: 'High-speed layer 1 blockchain.', keyFacts: { hours: '24/7', spread: 'Variable', contractSize: '1 SOL', leverage: '1:2' }, fundamentalDrivers: ['TPS Stats', 'App Growth', 'Ecosystem Funding'], tradingTips: ['Outperforms in bull runs.', 'Watch for outages.'], relatedInstruments: ['bitcoin', 'ethereum', 'avalanche'], bestBrokerId: 'etoro', relevantCoursePhase: 'Phase 6' },
  { slug: 'xrp', name: 'XRP', symbol: 'XRPUSD', type: 'crypto', description: 'Digital asset for cross-border payments.', keyFacts: { hours: '24/7', spread: 'Variable', contractSize: '1 XRP', leverage: '1:2' }, fundamentalDrivers: ['SEC Lawsuit', 'Bank Partnerships', 'Utility'], tradingTips: ['Highly news dependent.', 'Fastest settlement.'], relatedInstruments: ['bitcoin', 'ethereum', 'cardano'], bestBrokerId: 'etoro', relevantCoursePhase: 'Phase 6' },
  { slug: 'cardano', name: 'Cardano (ADA)', symbol: 'ADAUSD', type: 'crypto', description: 'Peer-reviewed blockchain platform.', keyFacts: { hours: '24/7', spread: 'Variable', contractSize: '1 ADA', leverage: '1:2' }, fundamentalDrivers: ['Research Papers', 'Ecosystem Launch', 'Voting'], tradingTips: ['Slower momentum.', 'Strong community.'], relatedInstruments: ['ethereum', 'solana', 'polygon'], bestBrokerId: 'etoro', relevantCoursePhase: 'Phase 6' },
  { slug: 'polygon', name: 'Polygon (MATIC)', symbol: 'MATICUSD', type: 'crypto', description: 'Layer 2 scaling for Ethereum.', keyFacts: { hours: '24/7', spread: 'Variable', contractSize: '1 MATIC', leverage: '1:2' }, fundamentalDrivers: ['ETH Scaling Needs', 'Partnerships', 'Zk-Tech'], tradingTips: ['Proxy play on ETH.', 'High developer activity.'], relatedInstruments: ['ethereum', 'cardano', 'chainlink'], bestBrokerId: 'etoro', relevantCoursePhase: 'Phase 6' },
  { slug: 'avalanche', name: 'Avalanche (AVAX)', symbol: 'AVAXUSD', type: 'crypto', description: 'Eco-friendly smart contract platform.', keyFacts: { hours: '24/7', spread: 'Variable', contractSize: '1 AVAX', leverage: '1:2' }, fundamentalDrivers: ['Subnet Adoption', 'Total Value Locked', 'Funding'], tradingTips: ['Strong institutional interest.', 'High TVL focus.'], relatedInstruments: ['solana', 'ethereum', 'bitcoin'], bestBrokerId: 'etoro', relevantCoursePhase: 'Phase 6' },
  { slug: 'chainlink', name: 'Chainlink (LINK)', symbol: 'LINKUSD', type: 'crypto', description: 'The industry-standard oracle network.', keyFacts: { hours: '24/7', spread: 'Variable', contractSize: '1 LINK', leverage: '1:2' }, fundamentalDrivers: ['Oracle Demand', 'CCIP Integration', 'Staking'], tradingTips: ['Utility driven.', 'Vital for DeFi.'], relatedInstruments: ['ethereum', 'polygon', 'bitcoin'], bestBrokerId: 'etoro', relevantCoursePhase: 'Phase 6' },
