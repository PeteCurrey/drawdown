  ...
  return (
    <div className="bg-background-primary min-h-screen">
      ...
      <div className="container mx-auto px-6">
          ...
          <table className="w-full border-collapse border border-border-slate">
            ...
            <tbody className="text-xs uppercase font-bold tracking-tight">
              {featuredFirms.map((firm) => (
                <tr key={firm.id} className="border-b border-border-slate/50 hover:bg-background-surface transition-colors">
        ...
        <div className="mb-32">
          <h2 className="text-3xl font-display font-black uppercase mb-12">Pete's Honest Recommendation</h2>
          {petesPick && (
            <div className="bg-background-elevated border border-accent/30 p-12 relative overflow-hidden">
               <div className="absolute top-0 right-0 p-8 text-9xl font-display font-black text-accent/5 select-none uppercase">PICK</div>
               <div className="relative z-10 max-w-4xl">
                 <h3 className="text-4xl font-display font-black uppercase mb-6">{petesPick.name}</h3>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                   ...
                   <div className="space-y-4">
                     <h4 className="text-[10px] font-mono font-black text-loss uppercase tracking-[0.2em] flex items-center gap-2">
        ...
        {/* Final CTA */}
        <div className="p-16 bg-background-elevated border border-border-slate text-center relative overflow-hidden mb-24">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-3xl font-display font-black uppercase mb-6">Need More Options?</h2>
