        ...
        <div className="max-w-7xl mx-auto px-6 space-y-32">
          ...
          <div className="space-y-12">
            <div className="space-y-4">
               <h2 className="text-3xl font-sans font-bold uppercase tracking-tight">Regulated Forex & Futures</h2>
          ...
          <div className="space-y-12">
            <div className="space-y-4">
               <h2 className="text-3xl font-sans font-bold uppercase tracking-tight">Equities, Options & Bonds</h2>
               <div className="w-24 h-1 bg-accent" />
            </div>
            <div className="grid grid-cols-1 gap-8">
