...
<BlogChart type="liquidity" title="Institutional Liquidity Sweep" />
...
<BlogTable 
  ...
  rows="Drawdown Event | **Averages down** to lower cost basis, increasing risk. | **Stops out mechanically** at 1%, conserving capital. ; Winning Move | **Takes profits early** out of fear of losing green figures. | **Scales in** to compound the win in strong trends. ; Risk Sizing | **Full position** on first entry based on excitement. | **Starts small (25%)**, adds only on market structural breaks. ; Trade Stop-Loss | **Moves stop wider** to avoid being proven wrong. | **Fixed stop-loss** that remains untouched once placed."
/>
