      ...
      <div className="max-w-7xl mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-invert prose-drawdown max-w-none space-y-12 text-text-secondary leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">1. Not Financial Advice</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">2. Accuracy of Information</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">3. AI Tool Limitations</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-text-primary">4. Testimonials & Performance</h2>
            <p>
          ...
          <section className="p-8 bg-background-elevated/40 border border-border-slate/50 text-center">
