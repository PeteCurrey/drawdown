...
export default function HowToTradeSuccessPage() {
  return (
    <div className="min-h-screen bg-[#08090D] text-[#E4E2DD] flex items-center justify-center px-6 py-24">
      <div className="max-w-lg w-full text-center space-y-8">
        <div className="w-16 h-16 rounded-full bg-[#F9771D]/10 border border-[#F9771D]/30 flex items-center justify-center mx-auto">
          <Check className="w-8 h-8 text-[#F9771D]" />
        </div>

        <div className="space-y-3">
          <p className="text-xs font-mono uppercase tracking-[0.3em] text-[#F9771D]">// ORDER CONFIRMED</p>
          <h1 className="text-3xl font-bold uppercase">Your guide is on its way.</h1>
          <p className="text-[#7A7D85]">
            Check your email — your download link for <strong className="text-[#E4E2DD]">How to Trade</strong> is waiting. If you don't see it within a few minutes, check your spam folder.
          </p>
        </div>

        <div className="p-6 bg-[#111318] border border-[#1A1D24] rounded-xl text-left space-y-4">
          <p className="text-xs font-mono uppercase tracking-widest text-[#F9771D] font-bold">// NEXT STEPS</p>
          {[
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            ...
            className="px-6 py-3 bg-[#F9771D] text-[#08090D] font-mono font-bold uppercase tracking-widest rounded-xl hover:opacity-90 transition-opacity"
          >
            Go to Downloads
          </Link>
          <Link
