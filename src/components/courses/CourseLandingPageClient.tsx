...
const THEME_MAP: Record<string, PhaseTheme> = {
  ...
  // Themes for new phases 10-13
  "macro-trader": {
    color: "text-sky-600",
    colorHex: "#0284c7",
    borderClass: "border-sky-200 text-sky-700 bg-sky-50",
    glowClass: "from-sky-600/10 via-white to-white",
    buttonBgClass: "bg-sky-600 hover:bg-sky-700 text-white shadow-sky-600/20"
  },
  "prop-firm-mastery": {
    color: "text-orange-600",
    colorHex: "#ea580c",
    borderClass: "border-orange-200 text-orange-700 bg-orange-50",
    glowClass: "from-orange-600/10 via-white to-white",
    buttonBgClass: "bg-orange-600 hover:bg-orange-700 text-white shadow-orange-600/20"
  },
  "ai-trader": {
    color: "text-fuchsia-600",
    colorHex: "#c026d3",
    borderClass: "border-fuchsia-200 text-fuchsia-700 bg-fuchsia-50",
    glowClass: "from-fuchsia-600/10 via-white to-white",
    buttonBgClass: "bg-fuchsia-600 hover:bg-fuchsia-700 text-white shadow-fuchsia-600/20"
  },
  "the-backtester": {
    color: "text-lime-600",
    colorHex: "#65a30d",
    borderClass: "border-lime-200 text-lime-700 bg-lime-50",
    glowClass: "from-lime-600/10 via-white to-white",
    buttonBgClass: "bg-lime-600 hover:bg-lime-700 text-white shadow-lime-600/20"
  }
};
