...
export const metadata: Metadata = getMetadata({
  title: "Best of Trading USA — Expert Rankings & Reviews",
  description: "The definitive rankings of the best forex brokers, stock platforms, and trading tools for US traders. Tailored for CFTC & NFA compliance.",
  path: "/us/best",
});

export default function USBestIndex() {
  return (
    <RegionalProvider region="us">
      <div className="pt-28 pb-24 bg-white min-h-screen">
        <TrackPageView path="/us/best" />
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {BEST_OF_PAGES_US.map((page) => (
              <Link 
                key={page.slug}
                href={`/us/best/${page.slug}`}
