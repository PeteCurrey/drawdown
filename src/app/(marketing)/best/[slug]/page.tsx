    ...
    <main className="min-h-screen bg-background-primary pt-32 pb-20 px-6">
      ...
      <div className="max-w-4xl mx-auto">
              ...
              {page.comparisonTable.map((item) => (
                <tr key={item.rank} className="border-b border-border-slate hover:bg-background-surface/50 transition-colors">
                  ...
                  <td className="p-4 text-right">
                    <Link href={item.link} className="inline-block bg-accent px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-background-primary hover:bg-accent-hover transition-colors">
                      Visit Site
                    </Link>
                  </td>
                </tr>
          ...
          {page.reviews.map((review, index) => (
            <div key={review.name} className="scroll-mt-32 border border-border-slate bg-background-elevated p-8 md:p-12 relative overflow-hidden group">
              ...
              <div className="pt-8 border-t border-border-slate flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <Link href={review.ctaLink} className="bg-text-primary text-background-primary px-8 py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-accent hover:text-background-primary transition-all text-center">
        ...
        <section className="bg-accent p-12 text-center space-y-6">
          <h2 className="text-4xl font-display font-bold text-background-primary uppercase">Ready to trade the truth?</h2>
