  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 pb-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-border-slate/50 pb-8">
        <div>
          <span className="text-accent font-mono text-[10px] uppercase tracking-widest block mb-2">// MORNING INTEL</span>
          <h1 className="text-3xl md:text-4xl font-display font-black uppercase text-text-primary">The Wire.</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-12">
          ...
          {/* Intel Card */}
          <div className="p-8 md:p-12 bg-background-surface border border-border-slate/50 rounded-xl relative overflow-hidden group shadow-[0_8px_32px_rgba(0,0,0,0.04)]">
             ...
             <div className="relative z-10 space-y-12">
                <div className="flex items-center justify-between">
                   ...
                   <span className="text-[10px] font-mono text-profit uppercase tracking-widest border border-profit/30 px-2 py-0.5 rounded-md font-bold bg-profit/5">Markets: Open</span>
                </div>
                ...
                <section className="space-y-4">
                   ...
                   <p className="text-xl text-text-primary leading-relaxed font-sans font-medium">
                ...
                <section className="space-y-6">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {[
                        ...
                        <div key={i} className="p-6 bg-background-elevated/40 border border-border-slate/50 space-y-2 rounded-xl">
                           <div className="flex justify-between items-center">
                              <span className="text-sm font-display font-bold uppercase">{item.pair}</span>
                              <span className="text-xs font-mono text-accent font-bold">{item.level}</span>
                           </div>
        ...
        <aside className="space-y-8">
           <div className="p-8 bg-background-surface border border-border-slate/50 rounded-xl space-y-6 shadow-[0_8px_32px_rgba(0,0,0,0.04)]">
              ...
              <button className="w-full pt-4 text-[10px] font-bold uppercase tracking-widest text-text-tertiary hover:text-accent transition-colors flex items-center justify-center gap-2 border-t border-border-slate/30">
                 View Full Calendar <ExternalLink className="w-3 h-3" />
              </button>
           </div>
 
           <div className="p-8 border border-border-slate/50 rounded-xl space-y-4 bg-background-surface/40">
              <h4 className="text-[10px] font-mono uppercase tracking-widest text-text-secondary font-bold">Briefing Archive</h4>
