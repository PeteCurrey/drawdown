...
export function RiskCalculator() {
  ...
  // Reset fields to original UK Forex default
  const handleReset = () => {
    setBalance(10000);
    setRiskPercent(1);
    setEntryPrice("1.2734");
  ...
  if (instrumentId === "forex-major" || instrumentId === "forex-minor") {
    // Determine dynamically from entry price or selection
    multiplier = parsedEntry > 50 ? 100 : 10000;
  } else if (instrumentId === "gold") {
    multiplier = 10; // $1.00 move is 10 pips (where 1 pip = $0.10, pip value = $10 per lot)
  } else {
    multiplier = 1; // Indices/Crypto/Oil use raw points/dollars
  }
  ...
  // Position Sizing
  // Position Size = Risk / (Distance * Pip Value)
  ...
  // 1 standard lot of Forex/Gold = 100,000 units
  const units = rawPositionSize * 100000;

  // Potential Profit (1:1, 1:2, 1:3 R:R)
  const potentialProfit12 = riskAmount * 2;

  // Account Impact
  const newBalance = balance - riskAmount;
  const accountImpactPercent = (newBalance / balance) * 100;

  // Maximum consecutive trades before down 50%
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
      ...
      <div className="lg:col-span-5 space-y-6 bg-background-surface border border-border-slate p-6 sm:p-8 backdrop-blur-md">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full bg-background-primary border border-border-slate p-3 text-sm font-bold text-text-primary outline-none focus:border-accent"
            >
              {CURRENCIES.map(curr => (
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 border border-border-slate overflow-hidden">
              <button
                type="button"
                ...
                className={cn(
                  ...
                  direction === "Long" 
                    ? "bg-profit/10 text-profit border-r border-border-slate" 
              ...
              <button
                ...
                className={cn(
                  "py-3 text-[10px] font-mono font-bold uppercase transition-all",
                  direction === "Short" 
                    ? "bg-loss/10 text-loss border-l border-border-slate" 
                    : "bg-background-primary text-text-tertiary hover:text-text-secondary"
                )}
              >
                Sell (Short)
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-background-primary border border-border-slate p-4 text-lg font-mono font-bold outline-none focus:border-accent"
              />
            </div>
          </div>

          <div className="space-y-2 bg-background-primary/30 p-4 border border-border-slate/50">
            ...
            />
            <div className="flex justify-between text-[9px] font-mono text-text-tertiary mt-2">
              <span>0.1% Min</span>
              <span>1.0% Def</span>
              <span>5.0% Max</span>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full bg-background-primary border border-border-slate p-3 text-sm font-mono outline-none focus:border-accent text-text-primary font-bold"
            />
          </div>
        </div>

        {/* Custom Pip Value field (Visible only when Custom is chosen) */}
        {instrumentId === "custom" && (
          <div className="space-y-2 bg-accent/5 p-4 border border-accent/20">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <input 
              ...
              placeholder="1.2734"
              className="w-full bg-background-primary border border-border-slate p-4 text-base font-mono outline-none focus:border-accent text-text-primary font-bold"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-background-primary border border-border-slate p-3 text-xs font-mono outline-none focus:border-accent"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-background-primary border border-border-slate p-3 pl-8 text-xs font-mono outline-none focus:border-accent"
                />
              </div>
            </div>
          </div>
      ...
      <div className="lg:col-span-7 flex flex-col gap-6">
        ...
        {/* Alerts & Errors */}
        {entryEqualsSL && (
          <div className="p-4 bg-loss/10 border border-loss/20 text-loss rounded-sm flex items-start gap-3">
        ...
        {invalidDirection && (
          <div className="p-4 bg-warning/10 border border-warning/20 text-warning rounded-sm flex items-start gap-3">
            <AlertTriangle className="w-4 h-4 mt-0.5 shrink-0" />
        ...
        {highRiskWarning && (
          <div className="p-4 bg-warning/15 border border-warning/30 text-warning rounded-sm flex items-start gap-3">
        ...
        {dailyDrawdownBreached && (
          <div className="p-4 bg-loss/20 border border-loss/40 text-loss rounded-sm flex items-start gap-3 animate-pulse">
            <ShieldAlert className="w-4 h-4 mt-0.5 shrink-0" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 bg-background-surface border border-border-slate flex flex-col justify-between hover:border-accent transition-colors">
            <div className="flex justify-between items-start">
              <span className="text-[9px] font-mono text-text-tertiary uppercase tracking-widest">Calculated Position Size</span>
          ...
          <div className={cn(
            "p-6 border flex flex-col justify-between transition-colors",
            riskPercent < 1 
            ...
            <div className="flex justify-between items-start">
              <span className="text-[9px] font-mono text-text-tertiary uppercase tracking-widest">Risk Amount</span>
        ...
        <div className="bg-background-surface border border-border-slate p-6 space-y-4">
          <h4 className="text-[10px] font-mono font-black uppercase tracking-widest text-text-tertiary border-b border-border-slate/50 pb-2">// TRADE METRICS</h4>
          
          <div className="grid grid-cols-2 gap-y-4 text-xs font-mono">
            {/* Output 3: Stop Loss Distance */}
            <div>
              <p className="text-[9px] text-text-tertiary uppercase mb-1">Stop Loss Distance</p>
            ...
            <div>
              <p className="text-[9px] text-text-tertiary uppercase mb-1">Loss Account Balance</p>
              <p className="text-text-primary font-bold">
            ...
            {/* Output 6: Max Trades before down 50% */}
            <div className="col-span-2">
              <p className="text-[9px] text-text-tertiary uppercase mb-1">Longevity / Liquidation Buffer</p>
        ...
        <div className="bg-background-surface border border-border-slate p-6">
          <h4 className="text-[10px] font-mono font-black uppercase tracking-widest text-text-tertiary border-b border-border-slate/50 pb-2 mb-4">// REWARD TARGETS</h4>
            ...
            {[
              ...
              <div 
                ...
                className={cn(
                  "p-4 border",
                  rr.highlight 
                    ? "bg-profit/5 border-profit/30 text-profit" 
                    : "bg-background-primary border-border-slate/50 text-text-secondary"
                )}
              >
                <p className="text-[10px] font-mono uppercase tracking-wider mb-1">{rr.ratio} Reward</p>
        ...
        {/* Save/Login Panel */}
        <div className="bg-background-surface border border-border-slate p-6 flex flex-col md:flex-row justify-between items-center gap-4">
          {user ? (
            <div className="w-full space-y-3">
              ...
              <button
                ...
                className="w-full py-4 bg-accent hover:bg-accent-hover text-background-primary font-bold uppercase tracking-widest text-[10px] transition-all flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
              >
            ...
            <div className="w-full text-center md:text-left space-y-4">
              <div className="bg-background-primary p-4 border border-dashed border-border-slate text-center">
              ...
              <a
                href="/signup"
                className="block text-center w-full py-4 bg-background-elevated hover:bg-background-surface border border-border-slate hover:border-accent text-text-primary font-bold uppercase tracking-widest text-[10px] transition-all"
              >
                Create Free Account
              </a>
            </div>
