    ...
    <div className="pt-12 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-6 max-w-5xl">
        <div className="mb-12">
          ...
          <h1 className="font-sans font-bold uppercase text-text-primary">Profile.</h1>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5 p-8 md:p-12 space-y-12">
              <div className="flex items-center gap-8">
                ...
                <div>
                   <h2 className="text-2xl font-sans font-bold uppercase leading-none mb-2 text-text-primary">Pete Currey</h2>
                   <p className="text-xs font-mono uppercase tracking-widest text-text-tertiary">Member since April 2026</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-12 border-t border-border-slate/30">
                 <div className="space-y-2">
                    <label className="text-[10px] font-mono uppercase tracking-widest text-text-tertiary">Email Address</label>
                    <div className="flex items-center justify-between py-2 border-b border-border-slate/30">
                 ...
                 <div className="space-y-2">
                    ...
                    <div className="relative border-b border-border-slate/30 py-1">
                       <select 
                       ...
                       >
                          ...
                          <option value="Professional" className="">Professional</option>
                       </select>
            ...
            <div className="bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5 p-8 md:p-12">
               <div className="flex justify-between items-center mb-8">
                  <div className="flex items-center gap-3">
                    <Shield className="w-5 h-5 text-accent" />
                    <h3 className="text-xl font-sans font-bold uppercase text-text-primary">Subscription.</h3>
                  </div>
                  <span className="text-[10px] font-mono font-bold uppercase tracking-widest px-3 py-1 bg-mkt-ink text-white">Edge Tier</span>
               </div>
               
               <div className="p-6 bg-background-elevated/40 border border-border-slate/50 flex items-center justify-between mb-8">
               ...
               <div className="flex flex-col sm:flex-row gap-4">
                  <button className="w-full py-4 bg-background-elevated/40 border border-border-slate/50 text-[10px] font-bold uppercase tracking-widest hover:border-text-tertiary transition-colors">Cancel Subscription</button>
          ...
          <div className="space-y-8">
             <div className="bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5 p-8 space-y-8">
                ...
                <div className={cn(
                  ...
                  discordConnected ? "bg-profit/5 border-profit/20" : "bg-background-elevated/40 border-border-slate/50"
                )}>
                   <div className={cn(
                   ...
                   <button 
                    ...
                    className={cn(
                      ...
                      discordConnected ? "border border-border-slate/50 text-text-tertiary hover:text-red-500 hover:border-loss" : "bg-[#5865F2] text-text-primary hover:opacity-90"
                    )}
                   >
                ...
                {discordConnected && (
                  <div className="p-4 bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5 space-y-2">
                     <p className="text-[9px] font-mono uppercase tracking-widest text-text-tertiary">Active Roles</p>
                     <div className="flex flex-wrap gap-2">
                        <span className="text-[8px] font-bold uppercase tracking-widest px-2 py-0.5 border border-border-slate/50 text-accent">Edge Role</span>
                        <span className="text-[8px] font-bold uppercase tracking-widest px-2 py-0.5 border border-border-slate/50 text-text-tertiary">Verified Member</span>
                     </div>
                  </div>
                )}
             </div>

             <div className="p-8 border border-border-slate/50 text-center space-y-4">
