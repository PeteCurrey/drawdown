    ...
    <div className="flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             <div className="max-w-2xl space-y-8">
               ...
               <h1 className="  font-sans font-extrabold uppercase tracking-tight leading-[0.95]">
                 The Architecture of a <br />
                 <span className="text-mkt-ink">Passed Challenge.</span>
               </h1>
               
               <p className="text-lg md:text-xl text-mkt-i2 leading-relaxed font-medium">
             ...
             {/* Hero Visual Mockup */}
             <div className="relative border border-mkt-bd bg-white p-2 shadow-2xl">
                <div className="absolute -inset-1 bg-gradient-to-tr from-accent to-background-primary opacity-20 blur-xl" />
                <div className="relative bg-white p-8 aspect-square flex flex-col items-center justify-center text-center border border-mkt-bd/50">
                   <ShieldAlert className="w-16 h-16 text-red-500 mb-6" />
                   <h3 className="text-2xl font-sans font-black uppercase mb-4 text-mkt-ink">Stop Donating Evaluation Fees.</h3>
                   <p className="text-mkt-i2 text-sm">You are trading against a math formula designed to make you fail. It's time to use our math to beat theirs.</p>
                </div>
             </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white border-b border-mkt-bd">
         <div className="max-w-7xl mx-auto px-6 max-w-4xl text-center">
            <h2 className="text-3xl md:text-5xl font-sans font-black uppercase leading-tight mb-8">
               Another $500 fee gone. <br />
               <span className="text-mkt-i2">Another revenge trade spiral.</span>
            </h2>
            <p className="text-lg text-mkt-i2 leading-relaxed mb-6 text-left md:text-center">
            ...
            <p className="text-lg text-mkt-ink font-bold leading-relaxed text-left md:text-center">
      ...
      <section className="py-24 bg-white">
         <div className="max-w-7xl mx-auto px-6">
            <div className="mb-16 text-center">
               ...
               <h2 className="text-4xl font-sans font-bold uppercase">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
               <div className="p-8 border border-mkt-bd bg-white hover:border-mkt-bds/30 transition-colors">
                  ...
                  <h3 className="text-xl font-sans font-bold uppercase mb-4 text-mkt-ink">The Max-Drawdown Calculator</h3>
                  ...
                  <ul className="space-y-2">
                     <li className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-mkt-i4">
                        <CheckCircle2 className="w-3 h-3 text-mkt-grn" /> FTMO Logic Included
                     </li>
                     <li className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-mkt-i4">
                        <CheckCircle2 className="w-3 h-3 text-mkt-grn" /> The5%ers Logic Included
                     </li>
                  </ul>
               </div>
               ...
               <div className="p-8 border border-mkt-bd bg-white hover:border-mkt-bds/30 transition-colors">
                  ...
                  <h3 className="text-xl font-sans font-bold uppercase mb-4 text-mkt-ink">30-Day Evaluation Checklist</h3>
                  <p className="text-sm text-mkt-i2 leading-relaxed mb-6">
                  ...
                  <ul className="space-y-2">
                     <li className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-mkt-i4">
                        <CheckCircle2 className="w-3 h-3 text-mkt-grn" /> Pre-Market Routine
                     </li>
                     <li className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-mkt-i4">
                        <CheckCircle2 className="w-3 h-3 text-mkt-grn" /> End-of-Day Debrief
                     </li>
                  </ul>
               </div>
               ...
               <div className="p-8 border border-mkt-bd bg-white hover:border-mkt-bds/30 transition-colors">
                  ...
                  <h3 className="text-xl font-sans font-bold uppercase mb-4 text-mkt-ink">"The Tilt Protocol"</h3>
                  <p className="text-sm text-mkt-i2 leading-relaxed mb-6">
                  ...
                  <ul className="space-y-2">
                     <li className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-mkt-i4">
                        <CheckCircle2 className="w-3 h-3 text-mkt-grn" /> Hard-Stop Rules
                     </li>
                     <li className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-mkt-i4">
                        <CheckCircle2 className="w-3 h-3 text-mkt-grn" /> Recovery Math
                     </li>
                  </ul>
               </div>
            </div>
      ...
      <section className="py-24 bg-white border-t border-mkt-bd relative">
         <div className="max-w-7xl mx-auto px-6 text-center max-w-3xl">
            <h2 className="text-3xl md:text-5xl font-sans font-black uppercase tracking-tighter leading-none mb-8">
               Secure Your Edge.
            </h2>
            
            <div className="bg-white border border-mkt-bd p-8 mb-8 text-left">
               <div className="flex justify-between items-center mb-6 pb-6 border-b border-mkt-bd">
                  <div>
                     <h4 className="text-lg font-bold uppercase text-mkt-ink">Prop Challenge Survival Kit</h4>
                     <p className="text-xs text-mkt-i2">Digital PDF & Google Sheets Templates</p>
                  </div>
                  <div className="text-2xl font-sans font-black">£14</div>
               </div>

               {/* Bump Offer */}
               <label className="bg-accent/5 border border-mkt-bd/30 p-6 flex gap-4 items-start cursor-pointer hover:bg-accent/10 transition-colors">
                  <input
                    type="checkbox"
                    checked={includeBump}
            ...
            <p className="mt-8 text-xs text-mkt-i4 leading-relaxed">
