    ...
    <div className="pt-28 pb-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-6 max-w-4xl">
        ...
        <header className="mb-16">
          <h1 className="  font-sans font-bold uppercase mb-4">Privacy Policy</h1>
          <p className="text-mkt-i4 font-mono uppercase tracking-widest text-xs">Last Updated: April 14, 2026</p>
        </header>

        <div className="prose prose-invert prose-drawdown max-w-none space-y-12 text-mkt-i2 leading-relaxed">
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">1. Information We Collect</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">2. How We Use Your Data</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">3. Data Security & Storage</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">4. Cookies & Tracking</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">5. Your Rights</h2>
            <p>
          ...
          <section className="p-8 bg-[#F7F7F7] border border-mkt-bd">
            <h3 className="text-sm font-sans font-bold uppercase mb-2 text-mkt-ink">Contact Us regarding privacy</h3>
            <p className="text-xs">
