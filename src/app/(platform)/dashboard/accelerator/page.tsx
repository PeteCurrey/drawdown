...
export default function AcceleratorWorkspacePage() {
  ...
  const getMilestoneStatus = (weekNum: number) => {
    if (!enrolment) return { status: "locked", label: "LOCKED", color: "text-[#87877F] border-transparent" };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col justify-center items-center gap-4">
        ...
        <p className="text-xs font-mono uppercase tracking-widest text-[#87877F]">// INITIALIZING ACCELERATOR ENVIRONMENT...</p>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-20 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="grid grid-cols-3 gap-4 py-4 border-y border-[#1A1A1A]">
              <div>
                <p className="text-xs font-mono text-[#87877F]">// CAPACITY</p>
                <p className="text-lg md:text-2xl font-mono font-bold text-white">15 SEATS</p>
              </div>
              <div>
                <p className="text-xs font-mono text-[#87877F]">// CURRICULUM</p>
                <p className="text-lg md:text-2xl font-mono font-bold text-accent">6 WEEKS</p>
              </div>
              <div>
                <p className="text-xs font-mono text-[#87877F]">// COHORT CAP</p>
                ...
                <form onSubmit={handleApplySubmit} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      <label className="text-[10px] font-mono uppercase tracking-widest text-[#87877F]">Full Legal Name</label>
                      <input 
                        type="text" 
                        required
                        className="w-full bg-[#111] border border-[#222] focus:border-accent rounded-[6px] px-3 py-2 text-xs text-white focus:outline-none focus:ring-0 transition-colors"
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-mono uppercase tracking-widest text-[#87877F]">Secure Email Address</label>
                      <input 
                        type="email" 
                        required
                        className="w-full bg-[#111] border border-[#222] focus:border-accent rounded-[6px] px-3 py-2 text-xs text-white focus:outline-none focus:ring-0 transition-colors"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <label className="text-[10px] font-mono uppercase tracking-widest text-[#87877F]">Experience</label>
                        <select 
                          className="w-full bg-[#111] border border-[#222] focus:border-accent rounded-[6px] px-2 py-2 text-xs text-white focus:outline-none focus:ring-0"
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-mono uppercase tracking-widest text-[#87877F]">Trading Capital</label>
                        <select 
                          className="w-full bg-[#111] border border-[#222] focus:border-accent rounded-[6px] px-2 py-2 text-xs text-white focus:outline-none focus:ring-0"
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-mono uppercase tracking-widest text-[#87877F]">Your Development Goals</label>
                      <textarea 
                        required
                        rows={3}
                        className="w-full bg-[#111] border border-[#222] focus:border-accent rounded-[6px] px-3 py-2 text-xs text-white focus:outline-none focus:ring-0 resize-none transition-colors"
                  ...
                  {activeSeats >= 15 ? (
                    <button 
                      type="button" 
                      disabled
                      className="w-full bg-transparent border border-[#CE6969]/40 text-[#CE6969] rounded-[8px] py-3 text-[10px] font-mono uppercase tracking-widest"
                    >
                    ...
                    <button 
                      ...
                      className="w-full bg-accent hover:bg-accent-hover active:translate-y-px text-black font-bold uppercase tracking-widest py-3 text-[10px] rounded-[8px] transition-all shadow-[0_0_20px_rgba(24,184,128,0.2)] flex items-center justify-center gap-2"
                    >
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 border-t border-[#111]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.week} className="bg-[#0C0C0C] border border-[#151515] hover:border-[#1F1F1F] p-6 rounded-[8px] transition-all duration-300">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-[10px] font-mono text-[#87877F] uppercase">// PHASE 0{item.week}</span>
        ...
        <div className="max-w-7xl mx-auto px-6 py-10 md:py-14 flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              {enrolment?.cohort && (
                <span className="text-[10px] font-mono text-[#87877F] uppercase">
          ...
          {sessions.length > 0 ? (
            <div className="bg-[#0F0C08] border border-[#F9771D]/20 rounded-[8px] p-4 md:max-w-xs shrink-0 shadow-[0_0_20px_rgba(249,119,29,0.03)]">
            ...
            <div className="bg-[#0C0C0C] border border-[#1A1A1A] rounded-[8px] p-4 md:max-w-xs shrink-0">
              <div className="flex items-center gap-2 mb-1 text-[#87877F]">
              ...
              <p className="text-[9px] font-mono text-[#87877F] mt-1">Pete will post links to weekly private coaching workshops here.</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h3 className="text-xs font-mono uppercase tracking-widest text-[#87877F]">
              // 6-WEEK DEVELOPMENT LEDGER
            </h3>
            <button 
              onClick={loadDashboard}
              className="p-1.5 rounded-[6px] border border-[#1A1A1A] hover:bg-[#111] text-[#888] hover:text-white transition-colors flex items-center gap-1.5 text-[10px] font-mono"
            >
          ...
          <div className="space-y-4 border border-[#151515] bg-[#0A0A0A] rounded-2xl overflow-hidden p-2">
            {weeks.map((week: any) => {
              ...
              return (
                <div 
                  key={week.id}
                  className={`border rounded-[8px] transition-all duration-300 ${
                    isOpen 
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-mono text-[#87877F]">WEEK 0{week.week_number}</span>
                    ...
                    <div className="hidden md:flex items-center gap-4 text-right">
                      <div>
                        <p className="text-[9px] font-mono text-[#87877F] uppercase">// ESTIMATED EFFORT</p>
                    ...
                    <div className="p-6 border-t border-[#1C1C1C] space-y-6 bg-[#0B0B0B]">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 space-y-4">
                          <div className="space-y-1">
                            <span className="text-[9px] font-mono text-[#87877F] uppercase">WEEKLY SYLLABUS DIRECTIVE</span>
                          ...
                          {week.syllabus_outline && Array.isArray(week.syllabus_outline) && (
                            <div className="space-y-2">
                              <span className="text-[9px] font-mono text-[#87877F] uppercase">// CORE LESSONS & CHECKLIST</span>
                        ...
                        <div className="bg-[#0E0E0E] border border-[#1C1C1C] rounded-[8px] p-4 space-y-3">
                      ...
                      <div className="pt-6 border-t border-[#1C1C1C]">
                        ...
                        {meta.data?.grading_feedback && (
                          <div className="mb-6 bg-[#0E0B08] border border-[#F9771D]/20 rounded-[8px] p-5 space-y-3 shadow-[0_0_20px_rgba(249,119,29,0.02)]">
                            ...
                            <p className="text-xs text-white font-mono leading-relaxed bg-[#0A0806] border border-[#F9771D]/10 p-4 rounded-[6px] whitespace-pre-wrap">
                              {meta.data.grading_feedback}
                            </p>
                          </div>
                        )}
                        ...
                        {meta.status === "active" || meta.status === "needs_resubmission" ? (
                          <div className="bg-[#0C0C0C] border border-[#1A1A1A] rounded-[8px] p-6 space-y-4">
                            <div className="space-y-1">
                            ...
                            <div className="space-y-4">
                              <div className="space-y-1.5">
                                <label className="text-[9px] font-mono uppercase tracking-widest text-[#87877F]">Dossier Brief / Description Notes</label>
                                <textarea
                                  rows={5}
                                  required
                                  className="w-full bg-[#111] border border-[#222] focus:border-accent rounded-[6px] p-3.5 text-xs text-white focus:outline-none focus:ring-0 resize-none font-mono transition-colors"
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                                {/* File Upload Button */}
                                <div className="space-y-1.5">
                                  <label className="text-[9px] font-mono uppercase tracking-widest text-[#87877F]">Attach Code Script / Document</label>
                                  <div className="flex items-center gap-3">
                                    <label className="cursor-pointer flex items-center justify-center gap-2 px-4 py-2.5 rounded-[6px] border border-[#222] hover:border-accent hover:bg-[#111] text-xs font-mono text-[#999] hover:text-white transition-all">
                                ...
                                <div className="text-right">
                                  <button
                                    ...
                                    className="px-6 py-2.5 bg-accent hover:bg-accent-hover text-black font-bold text-[10px] font-mono uppercase tracking-widest rounded-[6px] transition-colors flex items-center gap-2 ml-auto"
                                  >
                          ...
                          <div className="bg-[#110D0A] border border-[#F9771D]/10 rounded-[8px] p-5 flex items-center gap-4">
                          ...
                          <div className="bg-[#0A110D] border border-[#18B880]/10 rounded-[8px] p-5 flex items-center gap-4">
