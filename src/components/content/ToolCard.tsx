...
export const ToolCard: React.FC<ToolCardProps> = ({
  ...
  return (
    <div className="my-10 bg-surface border border-border rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-accent/30 transition-all duration-300">
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-6">
          <div className="p-3 bg-elevated border border-border rounded-xl group-hover:bg-accent/5 group-hover:border-accent transition-colors">
        ...
        <h4 className="font-display text-xl text-white mb-3 uppercase tracking-tight">
          {toolName}
        </h4>
        ...
        <Link 
          href={`/tools/${toolSlug}`}
          className="inline-flex items-center gap-2 font-display text-xs font-bold uppercase tracking-widest text-accent hover:gap-4 transition-all"
        >
