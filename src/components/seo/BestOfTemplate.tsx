                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-background-surface">
                        <th className="p-6 text-[10px] font-mono uppercase tracking-widest text-text-tertiary border-b border-border-slate">Broker</th>
                        <th className="p-6 text-[10px] font-mono uppercase tracking-widest text-text-tertiary border-b border-border-slate">Avg Spread</th>
                        <th className="p-6 text-[10px] font-mono uppercase tracking-widest text-text-tertiary border-b border-border-slate">Leverage</th>
                        <th className="p-6 text-[10px] font-mono uppercase tracking-widest text-text-tertiary border-b border-border-slate">Rating</th>
                      </tr>
                    </thead>
                    <tbody>
          ...
          <aside className="lg:col-span-4">
             <div className="sticky top-32 space-y-8">
                <div className="p-8 border border-border-slate space-y-6">
                   <h4 className="text-[10px] font-mono uppercase tracking-widest text-text-tertiary font-bold">// WHY TRUST US</h4>
                   ...
                   <div className="space-y-4">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-2 text-[10px] font-mono uppercase text-text-primary">
