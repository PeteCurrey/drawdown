...
export default function AITradeJournalPage() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative pt-28 pb-24 overflow-hidden border-b border-border-slate/50">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="#demo" className="px-10 py-5 border border-border-slate/50 hover:border-text-primary text-text-primary font-sans font-bold uppercase tracking-[0.2em] text-sm transition-colors flex items-center justify-center gap-2">
              Watch Walkthrough
            </a>
          </div>
        </div>
      ...
      <section className="py-24 border-b border-border-slate/50 overflow-hidden">
         <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
               ...
               <div className="relative">
                  ...
                  <div className="relative bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5 p-2 shadow-2xl rounded-sm">
                     <div className="bg-background-surface/40 backdrop-blur-md border border-border-slate/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:border-border-slate hover:-translate-y-0.5/50 p-6 aspect-[4/3] flex flex-col">
                        {/* Mock Header */}
                        <div className="flex justify-between items-center mb-8 pb-4 border-b border-border-slate/30">
         ...
         <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div className="p-8 border border-border-slate/50 hover:border-border-slate/70 transition-colors">
                  ...
                  <h3 className="text-xl font-sans font-bold uppercase mb-4 text-text-primary">Automated Import</h3>
               ...
               <div className="p-8 border border-border-slate/50 hover:border-border-slate/70 transition-colors">
                  ...
                  <h3 className="text-xl font-sans font-bold uppercase mb-4 text-text-primary">Sentiment Tagging</h3>
                  <p className="text-sm text-text-secondary leading-relaxed">
               ...
               <div className="p-8 border border-border-slate/50 hover:border-border-slate/70 transition-colors">
                  ...
                  <h3 className="text-xl font-sans font-bold uppercase mb-4 text-text-primary">Performance Attribution</h3>
                  <p className="text-sm text-text-secondary leading-relaxed">
      ...
      <section className="py-24 border-y border-border-slate/50 relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto px-6 relative z-10 text-center max-w-4xl">
            <h3 className="text-2xl md:text-4xl font-sans italic text-text-primary leading-relaxed mb-8">
            ...
            <div className="flex items-center justify-center gap-4">
               <div className="w-12 h-12 rounded-full bg-border-slate border border-border-slate/50/30" />
      ...
      <section className="py-32">
         <div className="max-w-7xl mx-auto px-6 text-center max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
               ...
               <Link href="/tools" className="px-12 py-6 border border-border-slate/50 hover:border-text-primary text-text-primary font-sans font-bold uppercase tracking-[0.2em] text-sm transition-colors">
                  Explore Other Tools
               </Link>
            </div>
         </div>
