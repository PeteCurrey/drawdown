...
const tiers = [
  {
    name: "Foundation",
    id: "foundation",
    description: "For AU beginners building their knowledge base.",
    ...
    features: [
      ...
      { name: "ASIC Broker Directory Access", included: true },
      { name: "Position Size Calculator (AUD)", included: true },
      { name: "Community Discord Access", included: true },
      { name: "The Wire (AU Edition)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "AUD-Based Strategy Modules", included: true },
  ...
  },
  {
    name: "Floor",
    id: "floor",
    description: "Institutional access and bespoke AU strategy.",
  ...
  const handleSubscribe = async (tierId: string) => {
    ...
    try {
      ...
      const response = await fetch("/api/stripe/checkout", {
        ...
        body: JSON.stringify({ priceId: stripePriceId, tier: tierId, region: 'AU' }),
      });
      ...
      console.error(err);
      alert("Checkout failed. Contact support.");
    } finally {
      setLoadingTier(null);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-24 p-12 bg-background-elevated/40 border border-border-slate/50 max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center">
           ...
           <div className="space-y-4 text-center md:text-left">
              <h4 className="text-xl font-sans font-bold uppercase tracking-widest text-text-primary">ASIC AFSL Compliance</h4>
