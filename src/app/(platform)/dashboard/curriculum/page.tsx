      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
        {curriculumPhases.map((phase) => {
          ...
          return (
            <div 
              key={phase.num} 
              className="bg-white border border-[#EDEDED] rounded-2xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.08)] flex flex-col justify-between min-h-[260px] relative transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] hover:-translate-y-0.5 duration-200"
            >
              <div>
