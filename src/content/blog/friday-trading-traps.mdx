...
author: "Pete Currey"
metaTitle: "Friday Trading — Why Your Worst Day Might Be Predictable | Drawdown"
metaDescription: "Learn why Fridays are structurally designed to take your trading profits. Discover institutional gap risk, retail psychology trap, and professional rules."
heroImage:
  src: "https://images.unsplash.com/photo-1532187863486-abf9d39d66e8?q=80&w=800"
  alt: "Hourglass sitting on desk with trading screen background"
  caption: "Friday afternoons witness a structural drop in institutional order volume."
faq:
  - question: "Why is trading on Friday afternoon dangerous?"
    answer: "European markets close, and US institutional traders reduce their exposure to avoid weekend gap risk. This causes liquidity to drop and price action to become erratic."
  - question: "What is weekend gap risk?"
    answer: "Weekend gap risk is the probability that price will open significantly higher or lower on Sunday night than its Friday close, bypassing stop-loss orders."
  - question: "How should I modify my strategy on Fridays?"
    answer: "You should reduce your position sizing (e.g., cut it in half), avoid entering trades after 12:00 PM EST, and walk away if you've already met your weekly profit goals."
...
Weekend gap risk means Sunday's open can easily bypass your stop-loss, causing far larger losses than you planned.
</Callout>
...
This desire to "save the week" is lethal. This ties directly to our guide on [The Cost of Revenge Trading](/blog/cost-of-revenge-trading).
...
<DataTable 
  headers={["Parameter", "Retail Trader Action", "Institutional Trader Action"]} 
  rows={[
    ["Risk Tolerance", "Increases (Save the Week Syndrome)", "Decreases (Gap Risk Mitigation)"],
    ["Position Sizing", "Often doubles or triples to recover losses", "Halved or completely flattened"],
    ["Market Participation", "High activity in afternoon sessions", "Very low; desks closing early"],
    ["Market Environment", "Chasing erratic stop sweeps", "Taking profit and managing portfolio"]
  ]} 
  caption="Retail vs. Institutional Friday Behaviors: The mismatch that leads to predictable losses."
/>
