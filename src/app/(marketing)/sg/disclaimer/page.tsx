          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-12">
            ...
            <section className="p-8 bg-white border border-mkt-bd flex gap-6 items-start">
               ...
               <div>
                  ...
                  <p className="text-xs text-mkt-i4 leading-relaxed">We strictly recommend MAS-regulated entities for Singaporean residents to ensure the highest level of capital protection and regulatory oversight.</p>
               </div>
            </section>
          </div>
        </div>
