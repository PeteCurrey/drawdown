        ...
        <div className="max-w-4xl mt-12 space-y-16">
          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-12">
            <section className="space-y-6">
               <h2 className="text-2xl font-display font-bold uppercase tracking-tight">Not a Financial Advisor</h2>
            ...
            <section className="space-y-6">
               <h2 className="text-2xl font-display font-bold uppercase tracking-tight">High Risk Investment Warning</h2>
               <p className="text-lg text-text-secondary leading-relaxed">
            ...
            <section className="p-8 bg-background-surface border border-border-slate flex gap-6 items-start">
               ...
               <div>
                  <h3 className="font-display font-bold uppercase mb-2">MAS Compliance</h3>
