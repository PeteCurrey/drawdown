...
const tiers = [
  {
    ...
    description: "For Australian traders building their knowledge base.",
...
function PricingContent() {
  ...
  const handleSubscribe = async (tierName: string) => {
    ...
    try {
      ...
      // Select the correct currency price ID
      ...
      if (data.url) {
        ...
        window.location.href = "/login?redirect=/au/pricing";
      } else {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-text-secondary max-w-2xl mx-auto mb-12">
            Professional education and tools for Australian traders who are tired of the noise. 
        ...
        <div className="mt-24 p-8 bg-background-elevated border border-border-slate max-w-4xl mx-auto">
          <h4 className="text-xs font-mono uppercase tracking-widest text-text-secondary mb-4">ASIC & Educational Platform Notice</h4>
          <p className="text-[10px] text-text-tertiary leading-relaxed font-mono">
            Subscription tiers represent access levels to educational content and proprietary analysis tools. Drawdown does not provide financial advice or trade signals. All strategies tested or journals analyzed remain the intellectual property of the user. Past performance is not indicative of future results. All prices in Australian Dollars (AUD).
          </p>
        </div>
      </div>
    </div>
