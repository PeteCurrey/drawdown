...
export const EXPERT_REVIEWERS: ResearchReviewer[] = [
  {
    ...
    qualification: "Internal Technical Review",
    role: "Internal Risk Methodology Review",
    reviewDate: "2026-08-01",
    comments: "Verified non-linear drawdown recovery formulas and probability distribution assumptions.",
  },
  {
    id: "rev-compliance",
    name: "Regulatory & Legal Entity Reviewer",
    qualification: "Internal Compliance Review",
    role: "Internal Regulatory Review",
