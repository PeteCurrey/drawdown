      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-5 p-8 border border-border-slate/50 bg-background-surface/40 backdrop-blur-md space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-mono uppercase tracking-widest text-text-tertiary">Reward-to-Risk Ratio (R:R)</label>
              <input 
                type="number"
                step="0.1"
                value={winLossRatio}
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-mono uppercase tracking-widest text-text-tertiary">Ruin Threshold (% Account Loss)</label>
              <input 
                type="number"
                value={ruinThreshold}
          ...
          <div className="lg:col-span-7 flex flex-col justify-between gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
              <div className="p-8 border border-border-slate/50 bg-background-primary/30 flex flex-col justify-between hover:border-accent transition-colors">
                <span className="text-[9px] font-mono text-text-tertiary uppercase tracking-widest">Expectancy Value</span>
                <div className="mt-8">
                  <p className={cn(
                  ...
                  <p className="text-[9px] font-mono text-text-tertiary mt-2 uppercase tracking-widest">NET EXPECTANCY PER TRADE</p>
                </div>
              </div>

              <div className="p-8 border border-border-slate/50 bg-background-primary/30 flex flex-col justify-between hover:border-accent transition-colors">
                <span className="text-[9px] font-mono text-text-tertiary uppercase tracking-widest">Risk of Ruin</span>
                <div className="mt-8">
                  <p className={cn(
                    "text-3xl font-sans font-black",
                  ...
                  <p className="text-[9px] font-mono text-text-tertiary mt-2 uppercase tracking-widest">PROBABILITY OF HIT THRESHOLD</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 border border-accent/20 bg-accent/5 flex items-start gap-4">
              ...
              <div>
                <h4 className="text-xs font-bold uppercase tracking-tight text-text-primary">Mathematical Inevitability</h4>
        ...
        <article className="prose prose-invert max-w-none text-text-secondary leading-relaxed mb-20 space-y-8 border-t border-border-slate/50/30 pt-16">
          <h2 className="text-3xl font-sans font-black uppercase text-text-primary">What is Risk of Ruin in Trading?</h2>
          <p>
          ...
          <h3 className="text-xl font-bold uppercase text-text-primary">Mathematical Logic</h3>
          <p>
