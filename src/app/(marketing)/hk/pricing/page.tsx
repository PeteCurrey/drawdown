...
const tiers = [
  {
    ...
    description: "For Hong Kong traders building their knowledge base.",
  ...
  const handleSubscribe = async (tierName: string) => {
    ...
    try {
      ...
      if (data.url) {
        ...
        window.location.href = "/login?redirect=/hk/pricing";
      } else {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-text-secondary max-w-2xl mx-auto mb-12">
            Professional education and tools for Hong Kong traders. 
        ...
        <div className="mt-24 p-8 bg-background-elevated border border-border-slate max-w-4xl mx-auto text-center">
          <p className="text-[10px] text-text-tertiary leading-relaxed font-mono uppercase tracking-widest">
            SFC Educational Notice: Drawdown provides institutional-grade education and tools. All prices in HKD.
          </p>
        </div>
      </div>
    </div>
