...
export default function PropSurvivalKitPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative pt-32 pb-20 bg-background-primary overflow-hidden border-b border-border-slate">
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             ...
             {/* Hero Visual Mockup */}
             <div className="relative border border-border-slate bg-background-surface p-2 shadow-2xl">
      ...
      <section className="py-24 bg-background-surface border-b border-border-slate">
         <div className="container mx-auto px-6 max-w-4xl text-center">
            <h2 className="text-3xl md:text-5xl font-display font-black uppercase leading-tight mb-8">
               ...
               <span className="text-text-secondary">Another revenge trade spiral.</span>
            </h2>
      ...
      <section className="py-24 bg-background-surface border-t border-border-slate relative">
         <div className="container mx-auto px-6 text-center max-w-3xl">
            <h2 className="text-3xl md:text-5xl font-display font-black uppercase tracking-tighter leading-none mb-8">
               Secure Your Edge.
            </h2>
