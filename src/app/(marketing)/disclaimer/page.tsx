      ...
      <div className="max-w-7xl mx-auto px-6 max-w-4xl">
        ...
        <header className="mb-16">
          <div className="flex items-center gap-3 text-warning mb-4">
            ...
            <h1 className="  font-sans font-bold uppercase">Risk Disclaimer</h1>
          </div>
        ...
        <div className="prose prose-invert prose-drawdown max-w-none space-y-12 text-mkt-i2 leading-relaxed">
          <section className="p-8 bg-warning/5 border border-warning/20 space-y-4">
            <div className="flex items-center gap-2 text-warning mb-2">
              ...
              <h2 className="text-sm font-sans font-bold uppercase m-0">Extremely Important: High Risk Warning</h2>
            </div>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">1. Not Financial Advice</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">2. Accuracy of Information</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">3. AI Tool Limitations</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-sans font-bold uppercase text-mkt-ink">4. Testimonials & Performance</h2>
            <p>
          ...
          <section className="p-8 bg-[#F7F7F7] border border-mkt-bd text-center">
