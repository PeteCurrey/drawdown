    ...
    sections: {
      ...
      howItWorks: {
        steps: [
          ...
          {
            title: "Generate Quantitative Code",
            description: "The engine produces production-ready, clean Python scripts (utilizing Pandas, NumPy, and Backtrader) or fully alerts-integrated TradingView Pine Script v5."
          },
          {
